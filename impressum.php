...
<head>
  ...
  <link rel="shortcut icon" href="media/favicon.ico" />
  <title>MOONSHOT – Impressum</title>
...
<body>
  <div id="wrapper">
    <div class="container container-violet">
      <h1 class="logo">
        <a href="index.php"><img src="media/moonshot-logo.svg" alt="Moonshot Logo" style="max-width: 500px;" title="Moonshot – The Innovation Game"></a>
        <!-- Hidden -->
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <p><strong>Google Analytics und Datenschutz</strong></p>
        <p>Unsere Website nutzt Google Analytics, welches Nutzerdaten speichert und verarbeitet. Möchten Nutzer ihre Daten schützen, können sie beispielsweise über ein Browser-Add-on Google Analytics selbständig deaktivieren.</p>

        <p><a href="index.php" title="Zurück zur Startseite">Zurück zur Startseite</a></p>
      </div>

    </div>

    <footer>
      <p>&copy; <?php echo date("Y"); ?> Martin Wiens, Till Hasbach.</p>
    </footer>
